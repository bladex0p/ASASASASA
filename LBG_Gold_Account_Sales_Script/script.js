/* -------------------------
   Interactive PDF Voice Notes (Overlay + Native PDF)
   ------------------------- */
...
// --------------------
// Step 2: Create transparent overlay for audio controls
// --------------------
...
overlay.style.zIndex = "999"; // above PDF
pdfContainer.appendChild(overlay);

// --------------------
// Step 3: Get the plus button and attach click event
// --------------------
...
function addAudioControls(x, y) {
  ...
  div.addEventListener("mousedown", (e) => {
    if (["BUTTON", "AUDIO"].includes(e.target.tagName)) return;
    isDragging = true;
